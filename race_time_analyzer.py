#From the validation_and_math_functions module import all the functions so they can be used here
from validation_and_math_functions import *
...
while race_count <= num_races:
    ...
    while time_count <= num_times:
        ...
        if slowest_overall is None or valid_time > slowest_overall:        
    ...
    race_count += 1
    if fastest_average is None or race_avg < fastest_average:
